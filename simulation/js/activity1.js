...
function activity1() {
   ...
   <h4 class="center-text fs-28px fb-700">Roots of Equation: Modified Newton Raphson Method</h4>
   <br><br>
...
function internal_calculations_1() {
    ...
    root_val_3 = act1_table_data1[2][3];
    func_val_3 = act1_table_data1[2][4];
    div.innerHTML = '';
    div.innerHTML = `
   ...
   <div style="text-align:left;" class="fs-18px">
      Initial guess x1 = 1
      <br>
      constant_df = df(x1) = ${constant_df.toFixed(4)}
      <br>
      x2 = x1 - f(x1) / constant_df
   </div>
   <br>
   <div id="act1-tb-box1">
...
function display_chart() {
    ...
    let y = act1_table_data1.map((data) => data[3]);
